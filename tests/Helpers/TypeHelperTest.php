...
class TypeHelperTest extends TestCase{
    ...
    public function testDeserializeFromPresentationFormatByClassAndType(): void{
        ...
        $this->assertInstanceOf(SIG::class,TypeHelper::deserializeFromPresentationFormatByClassAndType('NXT 1 2 19970102030405 19961211100908 2143 foo.nil. AIYADP8d3zYNyQwW2EM4wXVFdslEJcUx/fxkfBeH1El4ixPFhpfHFElxbvKoWmvjDTCmfiYy2X+8XpFjwICHc398kzWsTMKlxovpz2FnCTM=',DNSClass::IN,DNSType::SIG));
        ...
        $this->assertInstanceOf(RRSIG::class,TypeHelper::deserializeFromPresentationFormatByClassAndType('\# 159 0001 05 03 00015180 3E7C9DD7 3E5510D7 0A52 076578616D706C6503636F6D00 ',DNSClass::IN,DNSType::RRSIG));
        ...
        $this->assertInstanceOf(CSYNC::class,TypeHelper::deserializeFromPresentationFormatByClassAndType('\# 12 00000042 0003 000406000010',DNSClass::IN,DNSType::CSYNC));
        ...
        $this->assertInstanceOf(TSIG::class,TypeHelper::deserializeFromPresentationFormatByClassAndType('\# 47 09616C676F726974686D076578616D706C6503636F6D00 000000000000 0000 0004 01020304 0000 0000 0004 01020304',DNSClass::IN,DNSType::TSIG));
    ...
    public function testDeserializeFromWireFormatByClassAndType(): void{
        ...
        $this->assertInstanceOf(RRSIG::class,TypeHelper::deserializeFromWireFormatByClassAndType(hex2bin('0001').hex2bin('05').hex2bin('03').hex2bin('00015180').hex2bin('3E7C9DD7').hex2bin('3E5510D7').hex2bin('0A52').hex2bin('076578616D706C6503636F6D00').hex2bin(''),DNSClass::IN,DNSType::RRSIG));
        ...
        $this->assertInstanceOf(CSYNC::class,TypeHelper::deserializeFromWireFormatByClassAndType(hex2bin('00000042').hex2bin('0003').hex2bin('000406000010'),DNSClass::IN,DNSType::CSYNC));
        ...
        $this->assertInstanceOf(TSIG::class,TypeHelper::deserializeFromWireFormatByClassAndType(hex2bin('09616C676F726974686D076578616D706C6503636F6D00').hex2bin('000000000000').hex2bin('0000').hex2bin('0004').hex2bin('01020304').hex2bin('0000').hex2bin('0000').hex2bin('0004').hex2bin('01020304'),DNSClass::IN,DNSType::TSIG));
