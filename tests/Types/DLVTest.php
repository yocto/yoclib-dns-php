...
class DLVTest extends TestCase{
    ...
    public function testConstructor(): void{
        self::assertInstanceOf(DLV::class,new DLV([
...
//        self::assertSame('60485 5 1 2BB183AF5F22588179A53B0A98631FAD1A292118',(new DLV([
//            new UnsignedInteger16(60485),
//            new UnsignedInteger8(5),
//            new UnsignedInteger8(1),
//            new Binary(hex2bin('2BB183AF5F22588179A53B0A98631FAD1A292118')),
//        ]))->serializeToPresentationFormat());
        self::assertSame('60485 RSASHA1 1 2BB183AF5F22588179A53B0A98631FAD1A292118',(new DLV([
            new UnsignedInteger16(60485),
            new UnsignedInteger8(5),
            new UnsignedInteger8(1),
            new Binary(hex2bin('2BB183AF5F22588179A53B0A98631FAD1A292118')),
    ...
    public function testDeserializeFromPresentationFormat(): void{
        self::assertSame(5,DLV::deserializeFromPresentationFormat('60485 5 1 2BB183AF5F22588179A53B0A98631FAD1A292118')->getFields()[1]->getValue());
        self::assertSame(5,DLV::deserializeFromPresentationFormat('60485 RSASHA1 1 2BB183AF5F22588179A53B0A98631FAD1A292118')->getFields()[1]->getValue());
    }
    ...
    public function testDeserializeFromPresentationFormatTooLessFields(): void{
        self::expectException(DNSTypeException::class);
        self::expectExceptionMessage('DLV record should contain at least 4 fields.');

        DLV::deserializeFromPresentationFormat('');
    }
    ...
    public function testDeserializeFromPresentationFormatUnknownProtocol(): void{
        ...
        DLV::deserializeFromPresentationFormat('60485 NON-EXISTING 1 2BB183AF5F22588179A53B0A98631FAD1A292118');
    }
    ...
    public function testDeserializeFromPresentationFormatOddHexadecimalLength(): void{
        ...
        DLV::deserializeFromPresentationFormat('60485 RSASHA1 1 2BB183AF5F22588179A53B0A98631FAD1A29211');
    }
