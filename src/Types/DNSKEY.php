...
class DNSKEY extends Type{
     ...
     * @throws DNSTypeException
     */
    public static function deserializeFromPresentationFormat(string $data): DNSKEY{
        $tokens = LineLexer::tokenizeLine($data);
        if(count($tokens)<3){
            throw new DNSTypeException('DNSKEY record should contain at least 3 fields.');
        }
        $output = '';
     ...
     * @throws DNSTypeException
     */
    public static function deserializeFromWireFormat(string $data): DNSKEY{
        $offset = 0;
