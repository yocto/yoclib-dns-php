...
class OPENPGPKEY extends Type{
     ...
     * @throws DNSTypeException
     */
    public static function deserializeFromPresentationFormat(string $data): OPENPGPKEY{
        $tokens = LineLexer::tokenizeLine($data);
        if(count($tokens)<1){
            throw new DNSTypeException('OPENPGPKEY record should contain at least 1 field.');
        }
        $output = '';
     ...
     * @throws DNSTypeException
     */
    public static function deserializeFromWireFormat(string $data): OPENPGPKEY{
        return new self([
